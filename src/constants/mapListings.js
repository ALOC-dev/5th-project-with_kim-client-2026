...
const presentationDetails = [
  ...
  { title: '이문동 리모델링 투룸', deposit: '1.2억', features: ['엘리베이터', 'CCTV', '주차 가능'], supplyArea: '43㎡ (13평)', maintenance: '매월 8만원', walkingMinutes: 10, distance: '780m', safetyScore: 7.8, marketDiff: '-2%', marketPrice: '1.25억', reviews: 4, rating: 4.1, agent: { name: '이수진', office: '회기공인중개사무소', license: '서울 제22345호' }, risk: { level: '보통', mortgage: '확인 필요', ratio: '71%', lh: '가능', hug: '확인 필요' } },
