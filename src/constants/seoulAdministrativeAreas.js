export const SEOUL_DISTRICTS = {
  ...
  도봉구: ['쌍문동', '방학동', '창동', '도봉동'],
  동대문구: ['전농동', '신설동', '용두동', '제기동', '청량리동', '회기동', '휘경동', '이문동', '답십리동', '장안동'],
  ...
  서대문구: ['충정로2가', '충정로3가', '합동', '미근동', '냉천동', '천연동', '옥천동', '영천동', '현저동', '북아현동', '홍제동', '대현동', '대신동', '신촌동', '봉원동', '창천동', '연희동', '홍은동', '북가좌동', '남가좌동'],
  서초구: ['방배동', '양재동', '우면동', '원지동', '잠원동', '반포동', '서초동', '내곡동', '염곡동', '신원동'],
  성동구: ['상왕십리동', '하왕십리동', '홍익동', '도선동', '마장동', '사근동', '행당동', '응봉동', '금호동1가', '금호동2가', '금호동3가', '금호동4가', '옥수동', '성수동1가', '성수동2가', '송정동', '용답동'],
  성북구: ['성북동', '성북동1가', '돈암동', '동소문동1가', '동소문동2가', '동소문동3가', '동소문동4가', '동소문동5가', '동소문동6가', '동소문동7가', '삼선동1가', '삼선동2가', '삼선동3가', '삼선동4가', '삼선동5가', '동선동1가', '동선동2가', '동선동3가', '동선동4가', '동선동5가', '안암동1가', '안암동2가', '안암동3가', '안암동4가', '안암동5가', '보문동1가', '보문동2가', '보문동3가', '보문동4가', '보문동5가', '보문동6가', '보문동7가', '정릉동', '길음동', '종암동', '하월곡동', '상월곡동', '장위동', '석관동'],
  송파구: ['잠실동', '신천동', '풍납동', '송파동', '석촌동', '삼전동', '가락동', '문정동', '장지동', '방이동', '오금동', '거여동', '마천동'],
  양천구: ['신정동', '목동', '신월동'],
  영등포구: ['영등포동', '영등포동1가', '영등포동2가', '영등포동3가', '영등포동4가', '영등포동5가', '영등포동6가', '영등포동7가', '영등포동8가', '여의도동', '당산동1가', '당산동2가', '당산동3가', '당산동4가', '당산동5가', '당산동6가', '당산동', '도림동', '문래동1가', '문래동2가', '문래동3가', '문래동4가', '문래동5가', '문래동6가', '양평동1가', '양평동2가', '양평동3가', '양평동4가', '양평동5가', '양평동6가', '양화동', '신길동', '대림동'],
  용산구: ['후암동', '용산동2가', '용산동4가', '갈월동', '남영동', '동자동', '서계동', '청파동1가', '청파동2가', '청파동3가', '원효로1가', '원효로2가', '신창동', '산천동', '청암동', '원효로3가', '원효로4가', '효창동', '도원동', '용문동', '문배동', '신계동', '한강로1가', '한강로2가', '용산동3가', '용산동5가', '한강로3가', '이촌동', '이태원동', '한남동', '동빙고동', '서빙고동', '주성동', '용산동6가', '보광동'],
...
export const SEOUL_GU_OPTIONS = Object.keys(SEOUL_DISTRICTS);
